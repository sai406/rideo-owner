...
import com.mstech.rideioowner.activities.PlayBackActivity
import com.mstech.rideioowner.activities.TripAlertsActivity
...
class GetTripsAdapter(var context: Context, samplelist: MutableList<GetTripsResponse>) : RecyclerView.Adapter<GetTripsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        val m: GetTripsResponse = samplelist[position] as GetTripsResponse
